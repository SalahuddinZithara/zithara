...
const caseStudyData = [
  {
    ...
    objective: `Brown Bear was searching for a technology partner to improve their digital customer journey and enhance their customer experience, as they are committed to provide exceptional customer service.
    ...
    problem: `Brown Bear was searching for a technology partner to improve their digital customer journey and enhance their customer experience, as they are committed to provide exceptional customer service.
  ...
  },
  {
    ...
    solution: `Zithara Helped the brand understand that Singular ways to increase LTV yet have the customer repeat at regular intervals, they had to do away with steep discounts and reward their customers at each visit so the customers could convert the reward point for Future visits to the store. 
    ...
    finalResult: `The partnership with Zithara helped Meghavi Wellness Chain achieve its goals of increasing its customer LTV and attracting new customers. By using personalized discounts and a referral program, Meghavi was able to incentivize customers to spend more and refer their friends and family to the spa. 
  ...
  },
  {
    ...
    solution: `“Zithara’s New Age loyalty program was designed for offline retailers intending to Create their branded rewards, reward customers at every touch point, Allow redemption at the counter and online and effectively communicate with customers” 
